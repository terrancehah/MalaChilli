...
export function RegisterForm({
  ...
  const validateField = (name: string, value: string): string => {
    switch (name) {
      ...
      case "password":
        ...
        if (!passwordResult.isValid) return passwordResult.errors[0];
        return "";
    ...
    try {
      ...
      */
      ...
      if (
        ...
        errorMessage = getPasswordRequirements();
      } else if (err.message) {
        errorMessage = err.message;
      }

      // Add remaining attempts warning if close to limit
  ...
  return (
    <>
      ...
      {referralCode && (
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 px-3 py-2 rounded-lg text-xs mb-6">
